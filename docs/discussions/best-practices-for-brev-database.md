...
Below is a naive implementation of using the db to add users.
...
There are a couple flaws with this method:
...
2. The creation logic should be separated, otherwise you might find yourself replicating the logic in multiple places.
...
And that's it! We'd love to continue this discussion. Reach us [on slack](https://join.slack.com/t/brevworkspace/shared_invite/zt-i5sd2k04-QXxItvyIW3WqP7pWCushrg) or text Nader at 415-818-0207